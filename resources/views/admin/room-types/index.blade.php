    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Sample Room Type Card - Replace with actual data -->
                <div class="bg-white rounded-xl shadow-sm border border-primary-100 overflow-hidden hover:shadow-md transition duration-300">
                    ...
                    <div class="aspect-w-16 aspect-h-9 bg-gray-200">
                        <img src="/storage/images/rooms/standard-1.jpg" 
                             alt="Standard Room" 
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-3">
                            <h3 class="text-lg font-semibold text-secondary-900">Standard Room</h3>
                        ...
                        <p class="text-sm text-secondary-600 mb-4 line-clamp-2">
                            Comfortable standard room with modern amenities and city view.
                        </p>
                        
                        <div class="space-y-2 text-sm text-secondary-600 mb-4">
                            <div class="flex justify-between">
                                <span>Price per night:</span>
                                <span class="font-semibold text-secondary-900">Rp 500,000</span>
                            </div>
                            <div class="flex justify-between">
                                <span>Capacity:</span>
                                <span class="text-secondary-900">2 guests</span>
                            </div>
                            <div class="flex justify-between">
                                <span>Total rooms:</span>
                                <span class="text-secondary-900">10 rooms</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex flex-wrap gap-1">
                                <span class="px-2 py-1 text-xs bg-primary-100 text-primary-800 rounded">WiFi</span>
                                <span class="px-2 py-1 text-xs bg-primary-100 text-primary-800 rounded">AC</span>
                                <span class="px-2 py-1 text-xs bg-primary-100 text-primary-800 rounded">TV</span>
                                <span class="px-2 py-1 text-xs bg-primary-100 text-primary-800 rounded">+3 more</span>
                            </div>
                        </div>
                ...
                <!-- Add more room type cards here or loop through actual data -->
                
                <!-- Empty State for when no room types exist -->
